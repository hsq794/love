<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      &nbsp;<!--生成pdf 下载pdf-->
      <el-button type="primary" @click="addPdf">生成pdf <!--<i class="el-icon-circle-plus-outline"></i>--></el-button>
      <el-button type="primary" @click="downPdf">下载pdf <!--<i class="el-icon-circle-plus-outline"></i>--></el-button>
    </div>
...
export default {
  ...
  methods: {
    ...
    addPdf(){
      this.request.post("/pdf/addPdf").then(res =>{
        if (res.code==200) {
    ...
    downPdf(){
      this.request.post("/pdf/downloadPdf", {
            params: {
