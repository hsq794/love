...
<!--        <el-input v-model="form.usex" autocomplete="off"></el-input>-->
      ...
      <el-form-item label="爱心值">
        <el-input v-model="form.ulove" :disabled="true" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="电话">
        <el-input v-model="form.uphoto" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item label="地址">
        <el-input type="textarea" v-model="form.uaddress" autocomplete="off"></el-input>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    async getUser() {
      return (await this.request.get("/user/uid/" + this.user.uid)).data
    },
    save() {
